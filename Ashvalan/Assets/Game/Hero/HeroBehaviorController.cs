...
public class HeroBehaviorController : MonoBehaviour
{
    ...
    private void OnDeath()
    {
        ...
        // - Apply Cinematic Death Effect
        detection.pc.cinCam.ApplySmashEffect(detection.pc.gameObject, this.gameObject, 3f);
        detection.pc.cinCam.ApplyTimeDilation(0.5f, 3f);
